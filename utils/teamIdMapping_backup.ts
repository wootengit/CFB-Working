// ESPN Team ID Mapping for FBS College Football Teams ONLY
// Division 1A (FBS) schools ONLY - NO FCS, NO NAIA, NO D2, NO D3
export const TEAM_ID_MAPPING: Record<string, number> = {
  // FBS TEAMS ONLY - DIVISION 1A ONLY
  ...
  // FCS TEAMS - MAJOR CONFERENCES ONLY
  ...
  // Additional FCS Teams for Complete Coverage
